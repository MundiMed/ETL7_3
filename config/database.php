    ...
    'connections' => [
        ...
        'mysql_medicamentos_24' => [
         ...
         'mysql_acervo_25' => [
            ...
            'host' => env('DB_HOST', '187.102.244.36'),
            'port' => env('DB_PORT', '3306'),
            'database' => env('DB_DATABASE', 'medmecom_compras_arcos_acervo'),
            'username' => env('DB_USERNAME', 'medmecom'),
            'password' => env('DB_PASSWORD', '6Uc63IbF$'),
            'unix_socket' => env('DB_SOCKET', ''),
            'charset' => 'utf8mb4',
        ...
        'mysql_medicamentos_25' => [
            'driver' => 'mysql',
            'url' => env('DATABASE_URL'),
            'host' => env('DB_HOST', '187.102.244.36'),
            'port' => env('DB_PORT', '3306'),
            'database' => env('DB_DATABASE', 'medmecom_compras_arcos'),
            'username' => env('DB_USERNAME', 'medmecom'),
            'password' => env('DB_PASSWORD', '6Uc63IbF$'),
            'unix_socket' => env('DB_SOCKET', ''),
            'charset' => 'utf8mb4',
         ...
         'mysql_acervo_26' => [
            ...
            'host' => env('DB_HOST', '187.102.244.36'),
            'port' => env('DB_PORT', '3306'),
            'database' => env('DB_DATABASE', 'medmecom_compras_claudio_acervo'),
            'username' => env('DB_USERNAME', 'medmecom'),
            'password' => env('DB_PASSWORD', '6Uc63IbF$'),
            'unix_socket' => env('DB_SOCKET', ''),
            'charset' => 'utf8mb4',
        ...
        'mysql_medicamentos_26' => [
            'driver' => 'mysql',
            'url' => env('DATABASE_URL'),
            'host' => env('DB_HOST', '187.102.244.36'),
            'port' => env('DB_PORT', '3306'),
            'database' => env('DB_DATABASE', 'medmecom_compras_claudio'),
            'username' => env('DB_USERNAME', 'medmecom'),
            'password' => env('DB_PASSWORD', '6Uc63IbF$'),
            'unix_socket' => env('DB_SOCKET', ''),
            'charset' => 'utf8mb4',
